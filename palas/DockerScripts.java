...
public class DockerScripts {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //replace build.version placeholder with the application's version + git hash
        dockerComposeContents = dockerComposeContents.replace("${build.version}", appVersion + "-" + gitHash);
